...
namespace Consulo.Internal.Mssdw.Network
{
	...
	class EventRequest
	{
		...
		internal static EventRequest create(Packet packet)
		{
			...
			switch (eventKind)
			{
				case Consulo.Internal.Mssdw.Network.EventKind.SINGLE_STEP:
				case Consulo.Internal.Mssdw.Network.EventKind.BREAKPOINT:
				case Consulo.Internal.Mssdw.Network.EventKind.FRAME_POP:
				case Consulo.Internal.Mssdw.Network.EventKind.EXCEPTION:
				case Consulo.Internal.Mssdw.Network.EventKind.USER_DEFINED:
				case Consulo.Internal.Mssdw.Network.EventKind.THREAD_START:
				case Consulo.Internal.Mssdw.Network.EventKind.THREAD_DEATH:
				case Consulo.Internal.Mssdw.Network.EventKind.CLASS_PREPARE:
				case Consulo.Internal.Mssdw.Network.EventKind.CLASS_UNLOAD:
				case Consulo.Internal.Mssdw.Network.EventKind.CLASS_LOAD:
				case Consulo.Internal.Mssdw.Network.EventKind.FIELD_ACCESS:
				case Consulo.Internal.Mssdw.Network.EventKind.FIELD_MODIFICATION:
				case Consulo.Internal.Mssdw.Network.EventKind.EXCEPTION_CATCH:
				case Consulo.Internal.Mssdw.Network.EventKind.METHOD_ENTRY:
				case Consulo.Internal.Mssdw.Network.EventKind.METHOD_EXIT:
				case Consulo.Internal.Mssdw.Network.EventKind.METHOD_EXIT_WITH_RETURN_VALUE:
				case Consulo.Internal.Mssdw.Network.EventKind.MONITOR_CONTENDED_ENTER:
				case Consulo.Internal.Mssdw.Network.EventKind.MONITOR_CONTENDED_ENTERED:
				case Consulo.Internal.Mssdw.Network.EventKind.MONITOR_WAIT:
				case Consulo.Internal.Mssdw.Network.EventKind.MONITOR_WAITED:
				case Consulo.Internal.Mssdw.Network.EventKind.VM_START:
				case Consulo.Internal.Mssdw.Network.EventKind.VM_DEATH:
				case Consulo.Internal.Mssdw.Network.EventKind.VM_DISCONNECTED:
					break;
				default:
