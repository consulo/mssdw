...
namespace Microsoft.Samples.Debugging.CorDebug
{
	...
	{
		internal CorThread (ICorDebugThread thread) : base(thread)
		{
			m_th = thread;
		}
	...
	{
		internal CorFrame(ICorDebugFrame frame) : base(frame)
		{
			m_frame = frame;
		}
	...
	{
		internal CorChain(ICorDebugChain chain) : base(chain)
		{
			m_chain = chain;
		}
	...
	{
		internal CorCode(ICorDebugCode code) : base(code)
		{
			m_code = code;
		}
	...
	{
		internal CorFunction(ICorDebugFunction managedFunction) : base(managedFunction)
		{
			m_function = managedFunction;
		}
	...
	public class CorException : Exception
	{
		...
		public CorException(string message) : base(message)
		{
		}
		...
		public CorException(string message, Exception innerException) : base(message, innerException)
		{
		}
		...
		protected CorException(SerializationInfo info, StreamingContext context) : base(info, context)
		{
		}
	}
