...
#region Top-level interfaces
	...
	public interface ICorDebug
	{
		...
		//
		void DebugActiveProcess([In] uint id, [In] int win32Attach, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugProcess ppProcess);
		//
		void EnumerateProcesses([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugProcessEnum ppProcess);
		//
		void GetProcess([In] uint dwProcessId, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugProcess ppProcess);
		//
	...
	public class CorDebugClass : ICorDebug, CorDebug
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		public virtual extern void DebugActiveProcess([In] uint id, [In] int win32Attach, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugProcess ppProcess);

		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		public virtual extern void EnumerateProcesses([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugProcessEnum ppProcess);

		[MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		public virtual extern void GetProcess([In] uint dwProcessId, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugProcess ppProcess);
	...
	public interface ICorDebugController
	{
		...
		void HasQueuedCallbacks([In, MarshalAs(UnmanagedType.Interface)] ICorDebugThread pThread, [Out]
		out int pbQueued);

		void EnumerateThreads([Out, MarshalAs(UnmanagedType.Interface)]
		...
		void CanCommitChanges([In] uint cSnapshots, [In, MarshalAs(UnmanagedType.Interface)]
		ref ICorDebugEditAndContinueSnapshot pSnapshots, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugErrorInfoEnum pError);

		void CommitChanges([In] uint cSnapshots, [In, MarshalAs(UnmanagedType.Interface)]
		ref ICorDebugEditAndContinueSnapshot pSnapshots, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugErrorInfoEnum pError);
	}
	...
	public interface ICorDebugProcess : ICorDebugController
	{
		...
		new void IsRunning([Out]
		out int pbRunning);

		new void HasQueuedCallbacks([In, MarshalAs(UnmanagedType.Interface)] ICorDebugThread pThread, [Out]
		out int pbQueued);

		new void EnumerateThreads([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugThreadEnum ppThreads);
		...
		new void CanCommitChanges([In] uint cSnapshots, [In, MarshalAs(UnmanagedType.Interface)]
		ref ICorDebugEditAndContinueSnapshot pSnapshots, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugErrorInfoEnum pError);

		new void CommitChanges([In] uint cSnapshots, [In, MarshalAs(UnmanagedType.Interface)]
		ref ICorDebugEditAndContinueSnapshot pSnapshots, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugErrorInfoEnum pError);
		...
		void GetHandle([Out, ComAliasName("HPROCESS*")]
		out IntPtr phProcessHandle);

		void GetThread([In] uint dwThreadId, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugThread ppThread);

		void EnumerateObjects([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugObjectEnum ppObjects);

		void IsTransitionStub([In] ulong address, [Out]
		out int pbTransitionStub);

		void IsOSSuspended([In] uint threadID, [Out]
		out int pbSuspended);
		...
		void ReadMemory([In] ulong address, [In] uint size, [Out, MarshalAs(UnmanagedType.LPArray)] byte[] buffer, [Out, ComAliasName("SIZE_T*")]
		out IntPtr read);

		void WriteMemory([In] ulong address, [In] uint size, [In, MarshalAs(UnmanagedType.LPArray)] byte[] buffer, [Out, ComAliasName("SIZE_T*")]
		out IntPtr written);
		...
		void EnumerateAppDomains([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugAppDomainEnum ppAppDomains);

		void GetObject([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValue ppObject);

		void ThreadForFiberCookie([In] uint fiberCookie, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugThread ppThread);

		void GetHelperThreadID([Out]
		out uint pThreadID);
	}
	...
	public interface ICorDebugProcess2
	{
		...
		void GetThreadForTaskID([In] ulong taskid, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugThread2 ppThread);

		void GetVersion([Out]
		out _COR_VERSION version);

		void SetUnmanagedBreakpoint([In] ulong address, [In] uint bufsize, [Out, MarshalAs(UnmanagedType.LPArray)] byte[] buffer, [Out]
		out uint bufLen);
		...
		void GetDesiredNGENCompilerFlags([Out]
		out uint pdwFlags);

		void GetReferenceValueFromGCHandle([In] IntPtr handle, [Out, MarshalAs(UnmanagedType.Interface)]
	...
	public interface ICorDebugProcessEnum : ICorDebugEnum
	{
		...
		new void Clone([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugEnum ppEnum);

		new void GetCount([Out]
		out uint pcelt);

		[PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		int Next([In] uint celt, [Out, MarshalAs(UnmanagedType.LPArray)] ICorDebugProcess[] processes, [Out]
	...
	public interface ICorDebugAppDomain : ICorDebugController
	{
		...
		void GetProcess([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugProcess ppProcess);

		void EnumerateAssemblies([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugAssemblyEnum ppAssemblies);

		void GetModuleFromMetaDataInterface([In, MarshalAs(UnmanagedType.IUnknown)] object pIMetaData, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugModule ppModule);

		void EnumerateBreakpoints([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugBreakpointEnum ppBreakpoints);

		void EnumerateSteppers([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugStepperEnum ppSteppers);

		void IsAttached([Out]
		out int pbAttached);

		void GetName([In] uint cchName, [Out]
		out uint pcchName, [Out, MarshalAs(UnmanagedType.LPWStr)] StringBuilder szName);
	...
	public interface ICorDebugAppDomain2
	{
		...
		void GetArrayOrPointerType([In] CorElementType elementType, [In] uint nRank, [In, MarshalAs(UnmanagedType.Interface)] ICorDebugType pTypeArg, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugType ppType);

		void GetFunctionPointerType([In] uint nTypeArgs, [In, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] ICorDebugType[] ppTypeArgs, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugType ppType);
	}
	...
	public interface ICorDebugAppDomainEnum : ICorDebugEnum
	{
		...
		[PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		int Next([In] uint celt, [Out, MarshalAs(UnmanagedType.LPArray)] ICorDebugAppDomain[] values, [Out]
		out uint pceltFetched);
	}
...
#region Assembly
	...
	public interface ICorDebugAssembly
	{
		...
		void GetAppDomain([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugAppDomain ppAppDomain);

		void EnumerateModules([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugModuleEnum ppModules);

		void GetCodeBase([In] uint cchName, [Out]
		out uint pcchName, [MarshalAs(UnmanagedType.LPArray)] char[] szName);
	...
	public interface ICorDebugAssembly2
	{
		...
		void IsFullyTrusted([Out]
		out int pbFullyTrusted);
	}
	...
	public interface ICorDebugAssemblyEnum : ICorDebugEnum
	{
		...
		[PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		int Next([In] uint celt, [Out, MarshalAs(UnmanagedType.LPArray)] ICorDebugAssembly[] values, [Out]
		out uint pceltFetched);
	}
    #endregion Assembly
...
#region Execution Control
	...
	public interface ICorDebugBreakpointEnum : ICorDebugEnum
	{
		...
		[PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		int Next([In] uint celt, [Out, MarshalAs(UnmanagedType.LPArray)] ICorDebugBreakpoint[] breakpoints, [Out]
		out uint pceltFetched);
	}
	...
	public interface ICorDebugFunctionBreakpoint : ICorDebugBreakpoint
	{
		...
		new void IsActive([Out]
		out int pbActive);


		void GetFunction([Out, MarshalAs(UnmanagedType.Interface)]
	...
	public interface ICorDebugStepperEnum : ICorDebugEnum
	{
		...
		[PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		int Next([In] uint celt, [Out, MarshalAs(UnmanagedType.LPArray)] ICorDebugStepper[] steppers, [Out]
		out uint pceltFetched);
	}
...
#region Class, Type
	...
	public interface ICorDebugClass
	{
		...
		void GetModule([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugModule pModule);

		void GetToken([Out]
		out uint pTypeDef);

		void GetStaticFieldValue([In] uint fieldDef, [In, MarshalAs(UnmanagedType.Interface)] ICorDebugFrame pFrame, [Out, MarshalAs(UnmanagedType.Interface)]
	...
	public interface ICorDebugClass2
	{
		...
		void GetParameterizedType([In] CorElementType elementType, [In] uint nTypeArgs, [In, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] ICorDebugType[] ppTypeArgs, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugType ppType);
	...
	public interface ICorDebugType
	{
		...
		void GetClass([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugClass ppClass);


		void EnumerateTypeParameters([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugTypeEnum ppTyParEnum);

		void GetFirstTypeParameter([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugType value);

		void GetBase([Out, MarshalAs(UnmanagedType.Interface)]
	...
	public interface ICorDebugTypeEnum : ICorDebugEnum
	{
		...
		[PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		int Next([In] uint celt, [Out, MarshalAs(UnmanagedType.LPArray)] ICorDebugType[] values, [Out]
		out uint pceltFetched);
	}
...
#region Code and Function
	...
	public interface ICorDebugCode
	{
		...
		void CreateBreakpoint([In] uint offset, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugFunctionBreakpoint ppBreakpoint);


		void GetCode([In] uint startOffset, [In] uint endOffset, [In] uint cBufferAlloc, [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 5)] byte[] buffer, [Out]
		out uint pcBufferSize);

		void GetVersionNumber([Out]
		out uint nVersion);

		void GetILToNativeMapping([In] uint cMap, [Out]
		out uint pcMap, [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] COR_DEBUG_IL_TO_NATIVE_MAP[] map);

		void GetEnCRemapSequencePoints([In] uint cMap, [Out]
		out uint pcMap, [Out, MarshalAs(UnmanagedType.LPArray)] uint[] offsets);
	}
	...
	public interface ICorDebugCode2
	{
		...
		void GetCodeChunks([In] uint cbufSize, [Out]
		out uint pcnumChunks, [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] _CodeChunkInfo[] chunks);

		void GetCompilerFlags([Out]
		out uint pdwFlags);
	}
	...
	public interface ICorDebugCodeEnum : ICorDebugEnum
	{
		...
		[PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		int Next([In] uint celt, [Out, MarshalAs(UnmanagedType.LPArray)] ICorDebugCode[] values, [Out]
		out uint pceltFetched);
	}
	...
	public interface ICorDebugFunction
	{
		...
		void GetILCode([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugCode ppCode);

		void GetNativeCode([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugCode ppCode);

		void CreateBreakpoint([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugFunctionBreakpoint ppBreakpoint);

		void GetLocalVarSigToken([Out]
		out uint pmdSig);

		void GetCurrentVersionNumber([Out]
		out uint pnCurrentVersion);
	}
	...
	public interface ICorDebugFunction2
	{
		...
		void GetJMCStatus([Out]
		out int pbIsJustMyCode);

		void EnumerateNativeCode([Out, MarshalAs(UnmanagedType.Interface)]
...
#region Deprecated
	...
	public interface ICorDebugContext : ICorDebugObjectValue
	{
		...
		new void GetType([Out]
		out CorElementType pType);

		new void GetSize([Out]
		out uint pSize);

		new void GetAddress([Out]
		out ulong pAddress);

		new void CreateBreakpoint([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValueBreakpoint ppBreakpoint);


		new void GetClass([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugClass ppClass);

		new void GetFieldValue([In, MarshalAs(UnmanagedType.Interface)] ICorDebugClass pClass, [In] uint fieldDef, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValue ppValue);

		new void GetVirtualMethod([In] uint memberRef, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugFunction ppFunction);

		new void GetContext([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugContext ppContext);

		new void IsValueClass([Out]
		out int pbIsValueClass);

		new void GetManagedCopy([Out, MarshalAs(UnmanagedType.IUnknown)]
		out object ppObject);
	...
	public interface ICorDebugEditAndContinueSnapshot
	{
		...
		void CopyMetaData([In, MarshalAs(UnmanagedType.Interface)] IStream pIStream, [Out]
		out Guid pMvid);

		void GetMvid([Out]
		out Guid pMvid);

		void GetRoDataRVA([Out]
		out uint pRoDataRVA);

		void GetRwDataRVA([Out]
		out uint pRwDataRVA);

		void SetPEBytes([In, MarshalAs(UnmanagedType.Interface)] IStream pIStream);

		void SetILMap([In] uint mdFunction, [In] uint cMapSize, [In]
		ref COR_IL_MAP map);
	...
	public interface ICorDebugErrorInfoEnum : ICorDebugEnum
	{
		...
		[PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		int Next([In] uint celt, [Out, ComAliasName("ICorDebugEditAndContinueErrorInfo**")] IntPtr errors, [Out]
		out uint pceltFetched);
	}
...
#region Function Evaluation
	...
	public interface ICorDebugEval
	{
		...
		void NewArray([In] CorElementType elementType, [In, MarshalAs(UnmanagedType.Interface)] ICorDebugClass pElementClass, [In] uint rank, [In]
		ref uint dims, [In]
		ref uint lowBounds);
		...
		void GetResult([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValue ppResult);

		void GetThread([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugThread ppThread);

		void CreateValue([In] CorElementType elementType, [In, MarshalAs(UnmanagedType.Interface)] ICorDebugClass pElementClass, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValue ppValue);
	}
	...
	public interface ICorDebugEval2
	{
		...
		void CreateValueForType([In, MarshalAs(UnmanagedType.Interface)] ICorDebugType pType, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValue ppValue);
		...
		void NewParameterizedArray([In, MarshalAs(UnmanagedType.Interface)] ICorDebugType pElementType, [In] uint rank, [In]
		ref uint dims, [In]
		ref uint lowBounds);
...
#region ICorDebugValue
	...
	public interface ICorDebugValue2
	{
		...
		void GetExactType([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugType ppType);
	}
	...
	public interface ICorDebugReferenceValue : ICorDebugValue
	{
		...
		void Dereference([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValue ppValue);

		void DereferenceStrong([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValue ppValue);
	}
	...
	public interface ICorDebugHandleValue : ICorDebugReferenceValue
	{
		...
		new void GetValue([Out]
		out ulong pValue);

		new void SetValue([In] ulong value);

		new void Dereference([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValue ppValue);

		new void DereferenceStrong([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValue ppValue);


		void GetHandleType([Out]
	...
	public interface ICorDebugHeapValue : ICorDebugValue
	{
		...
		void CreateRelocBreakpoint([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValueBreakpoint ppBreakpoint);
	...
	public interface ICorDebugHeapValue2
	{
		...
		void CreateHandle([In] CorDebugHandleType type, [Out, MarshalAs(UnmanagedType.Interface)]
	...
	public interface ICorDebugBoxValue : ICorDebugHeapValue
	{
		...
		new void IsValid([Out]
		out int pbValid);


		new void CreateRelocBreakpoint([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValueBreakpoint ppBreakpoint);
	...
	public interface ICorDebugArrayValue : ICorDebugHeapValue
	{
		...
		void HasBaseIndicies([Out]
		out int pbHasBaseIndicies);

		void GetBaseIndicies([In] uint cdim, [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] uint[] indicies);

		void GetElement([In] uint cdim, [In, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] int[] indices, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValue ppValue);

		void GetElementAtPosition([In] uint nPosition, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValue ppValue);
	}
	...
	public interface ICorDebugValueBreakpoint : ICorDebugBreakpoint
	{
		...
		void GetValue([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValue ppValue);
	}
	...
	public interface ICorDebugValueEnum : ICorDebugEnum
	{
		...
		[PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		int Next([In] uint celt, [Out, MarshalAs(UnmanagedType.LPArray)] ICorDebugValue[] values, [Out]
		out uint pceltFetched);
	}
	...
	public interface ICorDebugStringValue : ICorDebugHeapValue
	{
		...
		void GetString([In] uint cchString, [Out]
		out uint pcchString, [Out, MarshalAs(UnmanagedType.LPWStr)] StringBuilder szString);
	}
	...
	public interface ICorDebugObjectValue : ICorDebugValue
	{
		...
		void GetFieldValue([In, MarshalAs(UnmanagedType.Interface)] ICorDebugClass pClass, [In] uint fieldDef, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValue ppValue);

		void GetVirtualMethod([In] uint memberRef, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugFunction ppFunction);

		void GetContext([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugContext ppContext);

		void IsValueClass([Out]
		out int pbIsValueClass);

		void GetManagedCopy([Out, MarshalAs(UnmanagedType.IUnknown)]
		out object ppObject);
	...
	public interface ICorDebugObjectValue2
	{
		...
		void GetVirtualMethodAndType([In] uint memberRef, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugFunction ppFunction, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugType ppType);
	}
	...
	public interface ICorDebugObjectEnum : ICorDebugEnum
	{
		...
		[PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		int Next([In] uint celt, [Out, MarshalAs(UnmanagedType.LPArray)] ulong[] objects, [Out]
		out uint pceltFetched);
	}
	...
	public interface ICorDebugChain
	{
		...
		void GetStackRange([Out]
		out ulong pStart, [Out]
		out ulong pEnd);

		void GetContext([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugContext ppContext);

		void GetCaller([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugChain ppChain);

		void GetCallee([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugChain ppChain);

		void GetPrevious([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugChain ppChain);

		void GetNext([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugChain ppChain);

		void IsManaged([Out]
		out int pManaged);

		void EnumerateFrames([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugFrameEnum ppFrames);

		void GetActiveFrame([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugFrame ppFrame);

		void GetRegisterSet([Out, MarshalAs(UnmanagedType.Interface)]
	...
	public interface ICorDebugChainEnum : ICorDebugEnum
	{
		...
		[PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		int Next([In] uint celt, [Out, MarshalAs(UnmanagedType.LPArray)] ICorDebugChain[] chains, [Out]
		out uint pceltFetched);
	}
	...
	public interface ICorDebugFrame
	{
		...
		void GetChain([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugChain ppChain);

		void GetCode([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugCode ppCode);

		void GetFunction([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugFunction ppFunction);

		void GetFunctionToken([Out]
		out uint pToken);
		...
		void CreateStepper([Out, MarshalAs(UnmanagedType.Interface)]
	...
	public interface ICorDebugFrameEnum : ICorDebugEnum
	{
		...
		[PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		int Next([In] uint celt, [Out, MarshalAs(UnmanagedType.LPArray)] ICorDebugFrame[] frames, [Out]
		out uint pceltFetched);
	}
	...
	public interface ICorDebugNativeFrame : ICorDebugFrame
	{
		...
		new void GetChain([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugChain ppChain);

		new void GetCode([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugCode ppCode);

		new void GetFunction([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugFunction ppFunction);

		new void GetFunctionToken([Out]
		out uint pToken);

		new void GetStackRange([Out]
		out ulong pStart, [Out]
		out ulong pEnd);

		new void GetCaller([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugFrame ppFrame);

		new void GetCallee([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugFrame ppFrame);

		new void CreateStepper([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugStepper ppStepper);
		...
		void GetLocalRegisterValue([In] CorDebugRegister reg, [In] uint cbSigBlob, [In, ComAliasName("Microsoft.Debugging.CorDebug.NativeApi.ULONG_PTR")] uint pvSigBlob, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValue ppValue);

		void GetLocalDoubleRegisterValue([In] CorDebugRegister highWordReg, [In] CorDebugRegister lowWordReg, [In] uint cbSigBlob, [In, ComAliasName("Microsoft.Debugging.CorDebug.NativeApi.ULONG_PTR")] uint pvSigBlob, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValue ppValue);

		void GetLocalMemoryValue([In] ulong address, [In] uint cbSigBlob, [In, ComAliasName("Microsoft.Debugging.CorDebug.NativeApi.ULONG_PTR")] uint pvSigBlob, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValue ppValue);

		void GetLocalRegisterMemoryValue([In] CorDebugRegister highWordReg, [In] ulong lowWordAddress, [In] uint cbSigBlob, [In, ComAliasName("Microsoft.Debugging.CorDebug.NativeApi.ULONG_PTR")] uint pvSigBlob, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValue ppValue);

		void GetLocalMemoryRegisterValue([In] ulong highWordAddress, [In] CorDebugRegister lowWordRegister, [In] uint cbSigBlob, [In, ComAliasName("Microsoft.Debugging.CorDebug.NativeApi.ULONG_PTR")] uint pvSigBlob, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValue ppValue);
	...
	public interface ICorDebugILFrame : ICorDebugFrame
	{
		...
		void EnumerateLocalVariables([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValueEnum ppValueEnum);

		void GetLocalVariable([In] uint dwIndex, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValue ppValue);

		void EnumerateArguments([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValueEnum ppValueEnum);

		void GetArgument([In] uint dwIndex, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValue ppValue);

		void GetStackDepth([Out]
		out uint pDepth);

		void GetStackValue([In] uint dwIndex, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValue ppValue);
	...
	public interface ICorDebugManagedCallback2
	{
		...
		void CreateConnection([In, MarshalAs(UnmanagedType.Interface)] ICorDebugProcess pProcess, [In] uint dwConnectionId, [In]
		ref ushort pConnName);
	...
	public interface ICorDebugModule
	{
		...
		void GetBaseAddress([Out]
		out ulong pAddress);

		void GetAssembly([Out, MarshalAs(UnmanagedType.Interface)]
		...
		void GetFunctionFromToken([In] uint methodDef, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugFunction ppFunction);

		void GetFunctionFromRVA([In] ulong rva, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugFunction ppFunction);

		void GetClassFromToken([In] uint typeDef, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugClass ppClass);

		void CreateBreakpoint([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugModuleBreakpoint ppBreakpoint);

		void GetEditAndContinueSnapshot([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugEditAndContinueSnapshot ppEditAndContinueSnapshot);


		void GetMetaDataInterface([In, ComAliasName("REFIID")]
		ref Guid riid, [Out, MarshalAs(UnmanagedType.Interface)]
		...
		void GetGlobalVariableValue([In] uint fieldDef, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugValue ppValue);
	...
	public interface ICorDebugModule2
	{
		...
		void SetJMCStatus([In] int bIsJustMyCode, [In] uint cTokens, [In]
		ref uint pTokens);
		...
		void GetJITCompilerFlags([Out]
		out uint pdwFlags);

		void ResolveAssembly([In] uint tkAssemblyRef, [Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugAssembly ppAssembly);
	}
	...
	public interface ICorDebugModuleEnum : ICorDebugEnum
	{
		...
		[PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		int Next([In] uint celt, [Out, MarshalAs(UnmanagedType.LPArray)] ICorDebugModule[] modules, [Out]
		out uint pceltFetched);
	}
...
#region MDA
	...
	public interface ICorDebugMDA
	{
		...
		void GetDescription([In] uint cchName, [Out]
		out uint pcchName, [MarshalAs(UnmanagedType.LPArray)] char[] szName);


		void GetXML([In] uint cchName, [Out]
		out uint pcchName, [MarshalAs(UnmanagedType.LPArray)] char[] szName);


		void GetFlags([Out]
		out CorDebugMDAFlags pFlags);


		void GetOSThreadId([Out]
		out uint pOsTid);
	}
    #endregion // MDA
	...
	public interface ICorDebugRegisterSet
	{
		...
		void GetRegistersAvailable([Out]
		out ulong pAvailable);
...
#region Threads
	...
	public interface ICorDebugThread
	{
		...
		void GetDebugState([Out]
		out CorDebugThreadState pState);

		void GetUserState([Out]
		out CorDebugUserState pState);

		void GetCurrentException([Out, MarshalAs(UnmanagedType.Interface)]
		...
		void EnumerateChains([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugChainEnum ppChains);

		void GetActiveChain([Out, MarshalAs(UnmanagedType.Interface)]
		out ICorDebugChain ppChain);
		...
		void CreateEval([Out, MarshalAs(UnmanagedType.Interface)]
	...
	public interface ICorDebugThread2
	{
		...
		void GetActiveFunctions([In] uint cFunctions, [Out]
		out uint pcFunctions, [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] COR_ACTIVE_FUNCTION[] pFunctions);

		void GetConnectionID([Out]
		out uint pdwConnectionId);

		void GetTaskID([Out]
		out ulong pTaskId);

		void GetVolatileOSThreadID([Out]
		out uint pdwTid);
	...
	public interface ICorDebugThreadEnum : ICorDebugEnum
	{
		...
		[PreserveSig, MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
		int Next([In] uint celt, [Out, MarshalAs(UnmanagedType.LPArray)] ICorDebugThread[] threads, [Out]
		out uint pceltFetched);
	}
